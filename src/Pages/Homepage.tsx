      ...
      <div className='relative md:w-[94vw] mx-auto min-h-screen overflow-x-hidden bg-black bg-opacity-[80%] md:bg-opacity-[90%]'>
        ...
        <div id='home' className='select-none relative z-[4449] md:px-10 px-6 mb-6 md:pb-10 mt-12 md:mt-[90px] w-[100%] h-max pt-16 border-slate-100'>
          ...
          <div className='relative mt-6 before:absolute before:top-0 before:h-px before:w-[200vw] before:bg-slate-900/80 dark:before:bg-white/10 before:-left-[100vw] after:absolute after:bottom-0 after:h-px after:w-[200vw] after:bg-slate-900/80 dark:after:bg-white/10 after:-left-[100vw]'>
            <p className='w-full md:w-max text-slate-300 md:px-3 text-md md:text-lg md:tracking-tighter md:text-balance max-md:font-medium animate-fadeIn delay-[1000ms]'>Welcome to my homebase—where ideas, creativity, and experience come together in a digital portfolio</p>
          </div>

          <div className='relative z-[99999] my-7 py-2 flex-col lg:flex items-center before:absolute before:top-0 before:h-px before:w-[200vw] before:bg-slate-900/80 dark:before:bg-white/10 before:-left-[100vw] after:absolute after:bottom-0 after:h-px after:w-[200vw] after:bg-slate-900/80 dark:after:bg-white/10 after:-left-[100vw]'>
            <button className='relative active:scale-[0.99] hover:brightness-[90%] z-[99999] outline-0 md:ml-4 md:mr-6 rounded-full bg-white px-4 py-3 w-max lg h-max text-center text-[14px] font-normal text-black animate-fadeIn delay-[1000ms]'>Download Resume</button>
            <div onClick={() => setActiveModalSearch(true)} className="active:scale-[0.99] outline-0 grid md:mt-0 mt-4 w-full md:w-[100px] grid-cols-[auto_1fr_auto] items-center gap-1 rounded-full px-4 py-3 text-left text-sm/6 sm:w-80 bg-white/5 text-white/50 animate-fadeIn delay-[1000ms]">
        ...
        <div id='languages' className='select-none px-6 md:px-14 relative md:flex flex-col z-[444] pb-[30px] md:pb-[80px] pt-6 md:pt-4 w-full h-max border-slate-100'>
          ...
          <motion.div
            ...
            <div className='relative z-[999] w-full h-full rounded-[20px] bg-white p-10 border border-black flex items-center justify-between  '>
              ...
              <img loading='lazy' src={TS} alt='iconLanguage' className='w-[34px] md:w-[80px] md:mb-0 mb-5 md:mr-14 z-[99999999999] grayscale-[100%]' />
        ...
        <div id='products' className='select-none px-6 md:px-14 relative md:flex flex-col z-[4444] pb-[30px] md:pb-[80px] pt-6 md:pt-4 w-full h-max border-slate-100'>
            ...
            >
              <div className='w-full h-full md:rounded-[20px] bg-white p-6'>
                ...
                <div className='w-full relative h-max md:h-full md:rounded-[24px] border border-gray-700 md:p-6'>
                  <div className='relative left-0 w-full h-[100%] md:rounded-[20px] overflow-hidden border border-slate-800 lg'>
          ...
          <div className='mt-12 md:mt-20'>
            ...
            <motion.div
              ...
              <div className='hidden md:flex w-max'>
                <div className="relative text-transparent flex items-center gap-6 md:mt-0 mt-4 md:p-6 after:absolute after:right-0 after:w-px after:h-[200vh] after:bg-slate-900/80 dark:after:bg-white/10 after:-top-[100vh]">
                  <p>konstruksi web</p>
                  <Link03Icon className='w-6 h-6' />
                </div>
              </div>
                ...
                ?.map((data: any, index: number) => (
                  <div key={index} className='w-full md:flex z-40 py-8 relative left-[0px] md:mt-[60px] h-max before:absolute before:top-0 before:h-px before:w-[200vw] before:bg-slate-900/80 dark:before:bg-white/10 before:-left-[100vw] after:absolute after:bottom-0 after:h-px after:w-[200vw] after:bg-slate-900/80 dark:after:bg-white/10 after:-left-[100vw]'>
                    <div className='relative w-full md:w-[50%] z-[99999] py-6 min-h-[400px]'>
                      ...
                      <p className='text-slate-300 w-full md:w-[85%] leading-loose tracking-tighter'>{data?.desc}</p>
                      ...
                      {
                        data?.image2 ? (
                          <div onClick={() => setSelectAccordion(2)} className={`relative h-max mt-6 w-full md:w-[85%] ${selectAccordion === 2 ? 'h-[140px]' : 'h-[80px]'} active:scale-[0.99] duration-200 ease-in-out py-3 border-y border-slate-700 overflow-hidden`}>
                      ...
                      <div onClick={(() => setSelectAccordion(1))} className={`relative h-max mt-6 w-full md:w-[85%] ${selectAccordion === 1 ? 'h-[140px]' : 'h-[80px]'} active:scale-[0.99] duration-200 ease-in-out py-3 border-y border-slate-700 overflow-hidden`}>
                        <div className='cursor-pointer w-full flex items-baseline justify-between py-3'>
                    ...
                    <div
                      className='relative w-full md:w-[50%] md:min-h-[400px] md:rounded-[24px] z-[8888888888888] flex justify-center items-center md:p-10 bg-white/20 backdrop-blur-2xl'
                    >
        ...
        <div id='linkedin' className='select-none px-6 md:px-14 relative md:flex flex-col z-[444] pb-[30px] md:pb-[80px] pt-6 md:pt-4 w-full h-max border-slate-100'>
          ...
          <motion.div
            ...
            <div className='w-full h-full bg-[#ffffff] p-4 md:p-10 md:rounded-[24px]'>
