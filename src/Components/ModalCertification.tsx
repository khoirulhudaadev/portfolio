    ...
    <section className='w-screen h-screen fixed left-0 bottom-0 bg-slate-900 bg-opacity-[0.7] lg:flex items-center justify-center z-[999999999999]'>
      <div className="relative md:left-[-16px] w-ful md:w-[70vw] h-full md:h-[80vh] bg-white/20 backdrop-blur-2xl md;p-4 md:rounded-[24px]">
        <div className="relative flex items-center justify-center w-full h-full bg-white md:rounded-[20px] shadow-lg z-[999999999999]">
          ...
          <div onClick={() => onClose()} className='md:w-max w-full md:flex hidden absolute right-0 top-14 p-4 cursor-pointer active:scale-[0.98]'>
          ...
          <div className="w-full h-max md:h-full mb-4 p-4">
            ...
            <div onClick={() => onClose()} className='text-red-500 border border-red-500 mx-auto w-max md:hidden flex mt-6 cursor-pointer active:scale-[0.98]'>
              <Cancel01Icon width={40} height={40} />
            </div>
          </div>
